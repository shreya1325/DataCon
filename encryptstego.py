...
def open_encode_window():
    ...
    if not encode_opened:
        ...
        encode_window.title("DataCon - Encode")
...
def open_decode_window():
    ...
    if not decode_opened:
        ...
        decode_window.title("DataCon - Decode")
...
def help_menu():
    ...
    if not help_opened:
        ...
        text_to_decode_label = Label(help_window,
                                     text="\nDataCon is an Image Steganography tool "
...
title_label = Label(window, text="DataCon")
title_label.config(font=("Open Sans", 35))
title_label.pack()
